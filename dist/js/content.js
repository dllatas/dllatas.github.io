...
var detail = exports.detail = [{
    ...
    task: ["Research on machine learning and affective computing. A strong focus on developing machine perception by means of machine learning to improve human-machine interaction.", "Image processing of extended Cohn-Kanade dataset and video processing of Affectiva-MIT facial expression dataset using OpenCV 2.4 Python’s library.", "Implementing a deep learning model using Google’s TensorFlow 0.7 library. This classifier was trained on static facial images.", "Fine tune the different parameters related to the model: network topology, learning rate, optimizers, kernel size, etc. Explore their impact on the training time and the classification accuracy."]
}, {
    project: "MoNAD",
