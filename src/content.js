...
export const detail = [
    ...
    , {
        ...
        , task: [
            "Get access to MIB dataset."
            , "Fine tune neural network parameters along with Zingo."
        ]
        , url: [
            {
                key: "1"
    ...
    , {
        ...
        , task: [
            "Internationalization of the app by implementing a JS native method to translate the content to English, Swedish and Spanish."
            , "Implement an UNDO/REDO JS native method on the payment interface, so users have a better experience at the moment of selecting beverages on their shopping carts."
        ]
        , url: [
            {
                key: "1"
    ...
    , {
        ...
        , task: [
            "Implement a native JS MVC framework."
            , "Internationalization of the app by implementing a JS native method to translate the content of the game to several languages."
            , "Generate a user settings screen. The user was able to set the background image, music theme and music volume for its game."
        ]
        , url: [
            {
                key: "1"
    ...
    , {
        ...
        , task: [
            "Songwriting of resolana and cintas."
            , "Record vocals for both songs."
        ]
        , url: [
            {
                key: "1"
    ...
    , {
        ...
        , task: [
            "It was developed using: React, SystemJS, ES2015."
        ]
        , url: [
            {
                key: "1"
