...
const data = [
        {id: "1", project: "facial emotion detection",
        ...
        , {id: "3", project: "bot twitter account detection",
        ...
        , {id: "9", project: "wijkmanska blecket",
...
ReactDOM.render(
    <section>
        ...
        <Components.ProjectModal project={"asdf"} desc={"asdf"} task={"asdf"} />
        <Components.Launch />
    </section>,
